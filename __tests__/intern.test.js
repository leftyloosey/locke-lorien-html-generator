...
const { Intern } = require("/Users/davidhardin/Desktop/ch/ch10/lib/class")
...
describe("Intern", () => {
    ...
    describe("getRole", () => {
        it("should run when called, console should log intern!", () => {
            nameOf = "bill"
            idOf = "42"
            emailOf = "bill@email"
            const bill = new Intern("kolij")
            ...
            bill.getRole()
        expect(mock).toHaveBeenCalled()
        expect(mock2).toBeCalledWith("intern!")
